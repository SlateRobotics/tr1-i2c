...
Ace128::Ace128(int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int pGnd) {
  this->p1 = p1;
  this->p2 = p2;
  this->p3 = p3;
  this->p4 = p4;
